function ButtonName=questdlg_SCK(Question,Title,Btn1,Btn2,Btn3,Default)
...
BtnPos{1} = [65 90 400 30];
BtnPos{2} = [65 50 400 30];
BtnPos{3} = [65 10 400 30];
%%%
...
%%% SCK
MsgTxtYOffset = 140; %MsgTxtYOffset + 15;
